...
var Flotr = {
  ...
  author: ['Bas Wenneker', 'Fabien Mager'],
        ...
        for(i = 0; i < series.length; i++){
          ...
          if(fragments.length > 0){
            ...
            if(options.legend.container != null){
              ...
              var div = this.el.insert('<div class="flotr-legend" style="position:absolute;z-index:1;' + pos +'">' + table + '</div>').select('div.flotr-legend')[0];
