$UI.Color = function(init) {
	var color = {
		...
		setRgb : function(r, g, b) {
			...
			var newHsv = $UI.ColorMethods.rgbToHsv(this);
			this.h = newHsv.h;
			this.s = newHsv.s;
			this.v = newHsv.v;

			this.hex = $UI.ColorMethods.rgbToHex(this);
		},
		...
		setHsv : function(h, s, v) {
			...
			var newRgb = $UI.ColorMethods.hsvToRgb(this);
			this.r = newRgb.r;
			this.g = newRgb.g;
			this.b = newRgb.b;

			this.hex = $UI.ColorMethods.rgbToHex(newRgb);
		},

		setHex : function(hex) {
			this.hex = hex;

			var newRgb = $UI.ColorMethods.hexToRgb(this.hex);
			this.r = newRgb.r;
			this.g = newRgb.g;
			this.b = newRgb.b;

			var newHsv = $UI.ColorMethods.rgbToHsv(newRgb);
			this.h = newHsv.h;
			this.s = newHsv.s;
			this.v = newHsv.v;
		}
...
$UI.ColorMethods = {
	...
	hexToWebSafe : function(hex) {
		...
		return intToHex(this.webSafeDec(this.hexToInt(r))) + this.intToHex(this.webSafeDec(this.hexToInt(g)))
